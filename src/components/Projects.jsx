        ...
        <section className='project-page' id='projects'>
            <div className='section-header'><p>My Projects</p></div>
                ...
                <div className='project2-color'>
                    <div className='project-space-container'>
                        <div className='project-left'>
                            <div className='project-title'><h3>Mattress Firm<br /> Transactional Email</h3></div>
                            <div className='project-text'><p>This is a transactional email from Mattress firm that confirms a recent purchase. It uses fluid hybrid design to achive the correct sizing on all devices.</p></div>
                            ...
                            <div className='view-project'><a href={`${process.env.PUBLIC_URL}/mattressfirm-transactional/mattressfirm.html`} target='_blank' rel='noopener noreferrer'>View Project</a></div>
                        </div>
                        <div className='project-right'>
